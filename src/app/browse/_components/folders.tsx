    ...
    <section className="space-y-6.5">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
        {mockData.map((folder, idx) => (
          <div key={idx} className="flex flex-col p-6 gap-4 rounded-xl bg-gray-200/50 hover:shadow cursor-pointer hover:scale-105 transition-transform duration-200 ease-in-out">
